          ...
          <TabPanel value={value} index={0}>
            <div className="row">
              <div className={classes.repons}>
                <a
                  href="https://tungxeko.com/an-dinh-chac-nich-ngay-khoi-chieu-16-04-ly-hai-tung-clip-lat-mat-48h-dam-chat-fast-furious-mien-song-nuoc-03-2021.html"
            ...
            <div className="row">
              ...
              <div className="col-sm-4 pl-0 pr-15">
                <a
                  href="https://dep.com.vn/vua-dep-lai-vua-tai-nang-dan-sao-nam-cua-phim-ban-tay-diet-quy-san-sang-don-tim-hoi-chi-em/"
                  className={classes.news}
                >
                  <img
                    className={classes.fullImg}
              ...
              <div className="col-sm-4 pl-0 pr-15">
                ...
                <a
                  className={classes.bonusNews}
                  href="https://m.facebook.com/tix.vn/posts/3623896171032194"
                >
                  <div className="row mb-2">
                    <div className="col-3 px-0">
                      <img
                ...
                <a
                  className={classes.bonusNews}
                  href="https://sao.baophapluat.vn/tin-tuc/chi-tiet/ngo-thanh-van-chinh-thuc-khoi-dong-cuoc-thi-thiet-ke-trang-phuc-cho-sieu-anh-hung-dau-tien-cua-viet-nam-13584/"
                >
                  <div className="row mb-2">
                    <div className="col-3 px-0">
                      <img
