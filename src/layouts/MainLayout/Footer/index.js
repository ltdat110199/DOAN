...
import logo from "../../../assets/img/logoloading.png";
          ...
          <div className={classes.social__width}>
            ...
            <div className={classes.footer__social}>
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.facebook.com/datisme.111"
              >
                <img
                  className={classes.logo}
      ...
      <div className={`${classes.footer__down} container`}>
        <div className="row">
          <div className="col-12 col-md-1 p-1 text-center">
            <img src={logo} alt="company" className={classes.logoCompany} />
          </div>
